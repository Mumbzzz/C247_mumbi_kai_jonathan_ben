"""Hyperparameter tuner for the EMG-to-keystroke RNN/Conformer model.
...
After tuning, launch full training with the best config:
    python -m Playground_Kai.train --model {rnn,conformer} \\
        --from-hyperparams Playground_Kai/checkpoints/best_hyperparams_{model}.yaml
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Two-phase hyperparameter tuner for the EMG RNN/Conformer model",
